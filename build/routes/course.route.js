...
courseRouter.get("/getVdoCipherOTP", course_controller_1.generateVideoUrl);
courseRouter.put("/delete-course/rid", auth_1.isAutheticated, (0, auth_1.authorizeRoles)("admin"), course_controller_1.deleteCourse);
